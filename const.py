...
selectedRectangleColor = (204,204,0)  # It was used for Selection Sort Algorithm
waitedRectangleColor=(204,204,0)    #This color shows the current searched (iterated) rectangle
...
offsetCircle=20         #Vertical difference between circle and bar that is going to be shifted
radiusCircle=10         #Radius of circle that is going to be used to sign "shifting"
thicknessCircle=10      #Thickness of circle that is going to be used to sign "shifting"   (THICKNESS <= RADIUS)
